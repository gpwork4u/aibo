...
export const PROJECTS_TESTIDS = {
  ...
  // Task Sheet (F-032c) — 對齊 fixture TASK_TESTIDS
  taskSheet: "task-sheet",
  taskSheetTitle: "task-sheet-title-input",
  taskSheetDescription: "task-sheet-description-input",
  taskSheetStatus: "task-sheet-status-select",
  taskSheetPriority: "task-sheet-priority-select",
  taskSheetDueDate: "task-sheet-due-date-input",
  taskSheetRefs: "task-sheet-refs-panel",
  taskSheetRefsList: "task-sheet-refs-list",
  taskSheetSave: "task-sheet-save-button",
  taskSheetComplete: "task-sheet-complete-button",
  taskSheetDelete: "task-sheet-delete-button",
  taskSheetDeleteConfirm: "task-sheet-delete-confirm-button",
  taskSheetClose: "task-sheet-close-button",
  taskSheetRefsItem: "task-sheet-refs-item",
  taskSheetRefsItemRemove: "task-sheet-refs-item-remove-button",
  taskSheetRefsItemDeletedBadge: "task-sheet-refs-item-deleted-badge",

  // Refs Picker — 對齊 fixture
  ...
  refsPickerSearch: "refs-picker-search-input",
